...
public class DealRequestHandler extends BaseClientRequestHandler {
	...
	public void handleClientRequest(User sender, ISFSObject params) {
		...
		for (User user : room.getUserList()) {
			...
			if(ch.equals("Miss Scarlet")){deck.addPlayer(Card.scarlet, user.getName(), Color.black, false);}
			if(ch.equals("Colonel Mustard")){deck.addPlayer(Card.mustard, user.getName(), Color.black, false);}
			if(ch.equals("Mr. Green")){deck.addPlayer(Card.green, user.getName(), Color.black, false);}
			if(ch.equals("Professor Plum")){deck.addPlayer(Card.plum, user.getName(), Color.black, false);}
			if(ch.equals("Mrs. White")){deck.addPlayer(Card.white, user.getName(), Color.black, false);}
			if(ch.equals("Mrs. Peacock")){deck.addPlayer(Card.peacock, user.getName(), Color.black, false);}
		}
