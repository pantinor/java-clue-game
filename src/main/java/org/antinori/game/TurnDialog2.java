...
public class TurnDialog2 extends javax.swing.JDialog {
    ...
    private void initComponents() {
		...
		if (!showDiceButton) rollDiceButton.setEnabled(false);
		if (!showSuggestionButton) makeSuggestionButton.setEnabled(false);
		if (!showSecretPassageButton) takeSecretPassageButton.setEnabled(false);
